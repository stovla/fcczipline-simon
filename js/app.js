...
window.addEventListener("load", function() {
    const colors = ["red", "blue", "darkorange", "green"];
    const sounds = {
        "red": new Audio("sound/simonSound1.mp3"),
        "blue": new Audio("sound/simonSound2.mp3"),
        "darkorange": new Audio("sound/simonSound4.mp3"),
    ...
    // enable all buttons when the player is playing
    function enableButtons() {
        for (var i = 0; i < 4; i++) {
            button[i].removeAttribute("disabled", true);
        }
    }
    // disable all buttons from start and when the player is not playing
    ...
    // updated to work with mobile devices
    for (var i = 0; i < 4; i++) {
